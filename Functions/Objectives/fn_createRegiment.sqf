...
switch (_regimentType) do {
	...
	case "Mechanized": {_regimentMarker = format ["%1_mech_inf", _regimentSide]; _regimentSpeed = 10; _values = [0.8, 0.5, 0.3, 0.1, 0.2]};
	case "Motorized": {_regimentMarker = format ["%1_Motor_inf", _regimentSide]; _regimentSpeed = 15; _values = [0.8, 0.1, 0.5, 0.2, 0.1]};
	case "Special Operations": {_regimentMarker = format ["%1_Recon", _regimentSide]; _regimentSpeed = 8; _values = [0.8, 0.1, 0.1, 0.5, 0.1]};
	case "Armored": {_regimentMarker = format ["%1_Armor", _regimentSide]; _regimentSpeed = 6; _values = [0.8, 0.2, 0.2, 0.2, 0.4]};
};
