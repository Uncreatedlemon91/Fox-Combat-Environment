...
if (_cost > _funds) then {
	...
	_veh clearItemCargoGlobal true;
	_veh clearWeaponCargoGlobal true;
	_veh clearBackpackCargoGlobal true;
	_veh clearMagazineCargoGlobal true;

	if (_veh == "ACM_B_NAG_AmmoBox") then {
